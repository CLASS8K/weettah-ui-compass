...
const BASE_URL = "https://weettah-ux-whisperer.lovable.app";
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        const destinationRouteId = "/destinations/$slug";
        if (isSitemapRouteIncluded(router.routesById[destinationRouteId])) {
          ...
          for (let offset = 0; ; ) {
            ...
            for (const row of data) {
              ...
              const path = sitemapPathForLocation(router, location, destinationRouteId);
